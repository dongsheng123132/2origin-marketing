...
## 2origin（本象协议）
- 🚀 `5c947f6` feat(website): restore original motherboard analogy and artwork
- 🚀 `a88ba69` feat(website): introduce AI computer overview and verified local cases
- 🚀 `2c0b9b0` story: 月落渡口边界声明定稿——三条 limits（约束只信声明态/CED词表未集外验证/导入史≠观察史）+ 生成器入库
...
- 🚀 **2origin** `5c947f6` feat(website): restore original motherboard analogy and artwork
- 🚀 **2origin** `a88ba69` feat(website): introduce AI computer overview and verified local cases
- 🚀 **2origin** `2c0b9b0` story: 月落渡口边界声明定稿——三条 limits（约束只信声明态/CED词表未集外验证/导入史≠观察史）+ 生成器入库

---
_由 refresh-notes.mjs 生成 · 2026-09-26 · 写稿规则见 AGENTS.md_
