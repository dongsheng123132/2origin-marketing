...
## 2origin（本象协议）
- 🚀 `9be25d4` website: 首页加"现场试用 Demo"入口，回归数据随最新写作/CAD进度重新生成
- 🚀 `776e15d` website: 动作包栏目补齐已上架 skill 与安装命令
- 🚀 `28fe797` website: 清理自动部署实测用的触发文件
...
- 🚀 **2origin** `9be25d4` website: 首页加"现场试用 Demo"入口，回归数据随最新写作/CAD进度重新生成
- 🚀 **2origin** `776e15d` website: 动作包栏目补齐已上架 skill 与安装命令
- 🚀 **2origin** `28fe797` website: 清理自动部署实测用的触发文件

---
_由 refresh-notes.mjs 生成 · 2026-09-06 · 写稿规则见 AGENTS.md_
